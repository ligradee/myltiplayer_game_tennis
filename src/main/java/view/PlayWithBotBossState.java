...
public class PlayWithBotBossState extends GameState {
    ...
    public PlayWithBotBossState(StateManager sManager) {
...
//        }
    ...
    public void keyPressed(int key) {
        ...
        if(key == KeyEvent.VK_RIGHT) {
            person.getModel().xSpeed = 6;
            if (ball.getModel().flag == false){
                ball.getModel().xSpeed = 6;
            }
